...
public class Console {
    ...
    public static void println(String message) {
        System.out.println(colorize(message, CYAN_TEXT()));
    }
    ...
    public static void showBoard(Board board) {
        System.out.print(colorize(board.toString(), GREEN_TEXT()));
    }
    ...
    public static Position promptForPosition(String prompt, Board board) {
        ...
        while (true) {
            ...
            if (input.length() != 3) {
                System.out.println(colorize(helpMessage, RED_TEXT()));
                continue;
            }
            ...
            try {
                ...
                if (board.isOccupiedAt(pos)) {
                    System.out.println(
                            colorize("That position is already taken.", RED_TEXT(), BOLD())
                    );
                    continue;
                }
